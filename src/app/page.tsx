  ...
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-20 left-10 w-32 h-32 bg-[#c8a871]/20 rounded-full opacity-20 animate-pulse"></div>
        <div className="absolute bottom-40 right-10 w-24 h-24 bg-[#c8a871]/20 rounded-full opacity-20 animate-bounce"></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-[#0c4c2d]/20 rounded-full opacity-20 animate-ping"></div>
      </div>
