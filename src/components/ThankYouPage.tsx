  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="bg-[#0c4c2d] p-6 text-center">
        ...
        <div className="p-6 md:p-8">
          <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
            <div className="w-48 h-48 relative rounded-full overflow-hidden border-4 border-[#c8a871]/30">
              <Image
                src="/doc.png"
                alt="Dr. Umang Shah"
                fill
            ...
            <div className="text-center md:text-left">
              <h2 className="text-xl md:text-2xl font-bold text-[#0c4c2d] mb-2">
                Dr. Umang Shah | Dr Jyoti Shah
              </h2>
              <p className="text-[#c8a871] font-medium mb-4">
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              <div className="bg-[#c8a871]/10 p-4 rounded-lg text-center">
                <div className="text-[#0c4c2d] text-xl font-bold mb-2">1</div>
                <p className="text-sm text-gray-600">
                  We&apos;ll review your appointment request within 2 hours
                </p>
              </div>
              <div className="bg-[#c8a871]/10 p-4 rounded-lg text-center">
                <div className="text-[#0c4c2d] text-xl font-bold mb-2">2</div>
                <p className="text-sm text-gray-600">
                  Our team will call you to confirm the appointment
                </p>
              </div>
              <div className="bg-[#c8a871]/10 p-4 rounded-lg text-center">
                <div className="text-[#0c4c2d] text-xl font-bold mb-2">3</div>
                <p className="text-sm text-gray-600">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              ...
              className="inline-flex justify-center items-center px-6 py-3 bg-[#0c4c2d] text-white font-medium rounded-lg hover:bg-[#0a3f26] transition-colors gap-2"
            >
