...
export default function ClinicPhotos({ onBookAppointment }: ClinicPhotosProps) {
  return (
    <section className="bg-[#c8a871]/10 p-4 md:p-8 lg:p-12">
      ...
      <button onClick={onBookAppointment} className="bg-[#c8a871] text-[#0c4c2d] py-3 px-6 rounded-lg font-bold w-full md:max-w-md mx-auto block hover:bg-[#b89a6a] transition-colors">
        BOOK APPOINTMENT
      </button>
    </section>
  );
